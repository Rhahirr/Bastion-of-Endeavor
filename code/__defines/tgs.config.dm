...
*/
#define TGS_INFO_LOG(message) log_to_dd("Инфо TGS: [##message]")
#define TGS_WARNING_LOG(message) log_to_dd("Предупреждение TGS: [##message]")
#define TGS_ERROR_LOG(message) log_to_dd("Ошибка TGS: [##message]")
