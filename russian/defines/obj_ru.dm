...
/obj/item/weapon/storage/part_replacer/New()
	..()
	ru_cases["rugender"] = "male"
	ru_cases["ncase"] = "Быстрый Заменитель Компонентов"
	ru_cases["gcase"] = "Быстрого Заменителя Компонентов"
	ru_cases["dcase"] = "Быстрому Заменителю Компонентов"
	ru_cases["acase"] = "Быстрый Заменитель Компонентов"
	ru_cases["icase"] = "Быстрым Заменителем Компонентов"
	ru_cases["pcase"] = "Быстром Заменителе Компонентов"
	name = "Быстрый Заменитель Компонентов"
...
/obj/item/weapon/storage/part_replacer/adv/New()
	..()
	ru_cases["rugender"] = "male"
	ru_cases["ncase"] = "Усовершенствованный Быстрый Заменитель Компонентов"
	ru_cases["gcase"] = "Усовершенствованного Быстрого Заменителя Компонентов"
	ru_cases["dcase"] = "Усовершенствованному Быстрому Заменителю Компонентов"
	ru_cases["acase"] = "Усовершенствованный Быстрый Заменитель Компонентов"
	ru_cases["icase"] = "Усовершенствованным Быстрым Заменителем Компонентов"
	ru_cases["pcase"] = "Усовершенствованном Быстром Заменителе Компонентов"
	name = "Усовершенствованный Быстрый Заменитель Компонентов"
